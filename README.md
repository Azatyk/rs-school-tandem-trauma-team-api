...
Tandem Trauma - веб-приложение для подготовки к техническим интервью по frontend-разработке. Платформа предоставляет теоретические вопросы с AI-оценкой ответов, систему подсказок, задачи на написание кода, отслеживание прогресса и таблицу лидеров.
